...
const BusinessUnitExposureCard: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-primary-lg overflow-hidden">
      {/* Card Header */}
      <div className="bg-primary-lg px-6 py-4 border-b border-primary-lg">
        ...
        {businessUnits.map((unit) => (
          <div 
            key={unit.name} 
            className="border border-primary-lg rounded-lg p-4 hover:shadow-md transition-shadow"
          >
            ...
            <div className="space-y-2">
              {unit.currencies.map((currency) => (
                <div 
                  ...
                  className="flex justify-between items-center p-2 bg-primary-xl rounded"
                >
      ...
      {/* Card Footer */}
      <div className="bg-gray-50 px-6 py-3 text-xs text-primary border-t border-primary-lg">
