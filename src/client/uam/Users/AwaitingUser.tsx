...
const Awaitinguser: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get("https://backend-5n7t.onrender.com/api/users/awaitingdata")
      .then((response) => {
  ...
  const handleBulkUserReject = () => {
    ...
    axios
      .post("https://backend-5n7t.onrender.com/api/users/bulk-reject", {
  ...
  const handleBulkUserApprove = () => {
    ...
    axios
      .post("https://backend-5n7t.onrender.com/api/users/bulk-approve", {
        userIds: selectedUserIds,
