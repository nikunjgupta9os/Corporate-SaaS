...
const AwaitingApproval: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get<BackendResponse>(
        "https://backend-5n7t.onrender.com/api/roles/awaitingData?nocache=${Date.now()}"
      )
      .then(({ data }) => {
  ...
  const handleBulkApprove = () => {
    ...
    axios
      .post("https://backend-5n7t.onrender.com/roles/bulk-approve", {
  ...
  const handleBulkReject = () => {
    ...
    axios
      .post("https://backend-5n7t.onrender.com/roles/bulk-reject", {
        roleIds: selectedRoleIds,
